		...
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
              ...
              <div class="row">
                  ...
                  <div class="form-group col-md-4">
                      <input type="text" name="contact" id="contact" placeholder="08xxxxxxxxxx" required class="form-control form-control-sm form-control-border" value="<?= isset($contact) ? $contact :"" ?>">
